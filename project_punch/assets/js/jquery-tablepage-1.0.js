	...
	$.fn.tablepage = function(oObj, dCountOfPage) {
		...
		function change_page_content()
		{
			...
			for (var i = 1; i <= dCount; i += dCountOfPage)
			{
				...
				{
					sPageStr += "<td valign='top'><table style='width:20px;height:20px;cursor:pointer;color:" + sFontColor + ";border-collapse:collapse;border-style:solid;border-width:1px;border-color:" + sNoSelColor + ";" + "'><tr><th>" + (dPageIndex++) + "</th></tr></table></td>";
				}
			}
